...
// Configuración de MongoDB - especificar la base de datos correcta
const MONGODB_URI = 'mongodb+srv://leandrosobko_db_user:39kokOttcCd8gZn1@cluster0.qkjc22r.mongodb.net/mobile-repair-ecommerce?retryWrites=true&w=majority&appName=Cluster0';
...
async function connectToMongoDB() {
  try {
    console.log('🔌 Conectando a MongoDB Atlas (mobile-repair-ecommerce)...');
    await mongoose.connect(MONGODB_URI, {
      bufferCommands: false,
      serverSelectionTimeoutMS: 10000,
    });
    console.log("✅ Conectado a MongoDB Atlas - mobile-repair-ecommerce");
  } catch (error) {
...
async function main() {
  console.log("🚀 MIGRACIÓN FINAL: Firebase → MongoDB Atlas (mobile-repair-ecommerce)");
  console.log("=" * 70);
  ...
  try {
    ...
    console.log("=" * 50);
    console.log("✅ Todos los datos migrados a mobile-repair-ecommerce");
